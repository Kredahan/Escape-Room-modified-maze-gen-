...
public class HuntAndKillMazeAlgorithm //##### Abstract Class Removal Point - took away MazeAlgorithm extension #####
{
    ...
    //public float generationStepDelay = 2;
    private MonoBehaviour _mb;

    public HuntAndKillMazeAlgorithm(MazeCell[,] mazeCells) //: base(mazeCells) //##### Abstract Class Removal Point - took away base #####
    {
        //##### Abstract Class Addition Point #####
        this.mazeCells = mazeCells;
        mazeRows = mazeCells.GetLength(0);
        mazeColumns = mazeCells.GetLength(1);
    }

    public void CreateMaze() //##### Abstract Class Removal Point - Took away override #####
    {
        HuntAndKill();
    }
